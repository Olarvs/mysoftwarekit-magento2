...
class Interceptor extends \Magento\Reports\Model\ResourceModel\Quote\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'prepareActiveCartItems');
        return $pluginInfo ? $this->___callPlugins('prepareActiveCartItems', func_get_args(), $pluginInfo) : parent::prepareActiveCartItems();
    }
