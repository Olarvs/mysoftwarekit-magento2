...
class Interceptor extends \Magento\Wishlist\Model\ResourceModel\Wishlist\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function filterByCustomerId($customerId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('filterByCustomerId', func_get_args(), $pluginInfo) : parent::filterByCustomerId($customerId);
    }
    ...
    public function filterByCustomerIds(array $customerIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('filterByCustomerIds', func_get_args(), $pluginInfo) : parent::filterByCustomerIds($customerIds);
    }
