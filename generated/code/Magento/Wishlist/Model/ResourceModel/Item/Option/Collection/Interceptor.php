...
class Interceptor extends \Magento\Wishlist\Model\ResourceModel\Item\Option\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addItemFilter($item)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addItemFilter', func_get_args(), $pluginInfo) : parent::addItemFilter($item);
    }
    ...
    public function getOptionsByItem($item)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getOptionsByItem', func_get_args(), $pluginInfo) : parent::getOptionsByItem($item);
    }
    ...
    public function getOptionsByProduct($product)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getOptionsByProduct', func_get_args(), $pluginInfo) : parent::getOptionsByProduct($product);
    }
