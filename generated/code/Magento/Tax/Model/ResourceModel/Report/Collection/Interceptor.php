...
class Interceptor extends \Magento\Tax\Model\ResourceModel\Report\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOrderStatusFilter');
        return $pluginInfo ? $this->___callPlugins('addOrderStatusFilter', func_get_args(), $pluginInfo) : parent::addOrderStatusFilter($orderStatus);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAggregatedColumns');
        return $pluginInfo ? $this->___callPlugins('setAggregatedColumns', func_get_args(), $pluginInfo) : parent::setAggregatedColumns($columns);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAggregatedColumns');
        return $pluginInfo ? $this->___callPlugins('getAggregatedColumns', func_get_args(), $pluginInfo) : parent::getAggregatedColumns();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isTotals');
        return $pluginInfo ? $this->___callPlugins('isTotals', func_get_args(), $pluginInfo) : parent::isTotals($flag);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isSubTotals');
        return $pluginInfo ? $this->___callPlugins('isSubTotals', func_get_args(), $pluginInfo) : parent::isSubTotals();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsSubTotals');
        return $pluginInfo ? $this->___callPlugins('setIsSubTotals', func_get_args(), $pluginInfo) : parent::setIsSubTotals($flag);
    }
