...
class Interceptor extends \Magento\Newsletter\Model\ResourceModel\Template\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'useOnlyActual');
        return $pluginInfo ? $this->___callPlugins('useOnlyActual', func_get_args(), $pluginInfo) : parent::useOnlyActual();
    }
