...
class Interceptor extends \Magento\Paypal\Model\ResourceModel\Report\Settlement\Row\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAccountFilter');
        return $pluginInfo ? $this->___callPlugins('addAccountFilter', func_get_args(), $pluginInfo) : parent::addAccountFilter($accountId);
    }
