...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Transaction\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOrderInformation');
        return $pluginInfo ? $this->___callPlugins('addOrderInformation', func_get_args(), $pluginInfo) : parent::addOrderInformation($keys);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPaymentInformation');
        return $pluginInfo ? $this->___callPlugins('addPaymentInformation', func_get_args(), $pluginInfo) : parent::addPaymentInformation($keys);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addOrderIdFilter');
        return $pluginInfo ? $this->___callPlugins('addOrderIdFilter', func_get_args(), $pluginInfo) : parent::addOrderIdFilter($orderId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPaymentIdFilter');
        return $pluginInfo ? $this->___callPlugins('addPaymentIdFilter', func_get_args(), $pluginInfo) : parent::addPaymentIdFilter($payment);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addParentIdFilter');
        return $pluginInfo ? $this->___callPlugins('addParentIdFilter', func_get_args(), $pluginInfo) : parent::addParentIdFilter($parentId);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTxnTypeFilter');
        return $pluginInfo ? $this->___callPlugins('addTxnTypeFilter', func_get_args(), $pluginInfo) : parent::addTxnTypeFilter($txnType);
    }
